...
| 6 | 2026-09-09 | **Repatriación / traslado internacional — servicio CONFIRMADO.** El cliente confirmó (2026-09-09) que LEGADO **sí ofrece** coordinación de repatriación/traslado internacional a Venezuela y que lo maneja el **personal de guardia 24/7**. Prompt ES/EN (PROCESO A, caso especial): se quitó el hedge "no prometas que el servicio existe" → Alma dice con seguridad que LEGADO puede ayudar; recoge nombre + ciudad/país de origen + ciudad de destino y `handoff_whatsapp` (necesidad = "Repatriación: de X a Y"). Sigue **sin** prometer tiempos/costos/requisitos (los define la guardia). | LEGADO (para FDZ casi N/A) | **CERRADA + DESPLEGADA** — `worker/src/alma.js` versión `8b3bd23d`, verificada en vivo. *Pendiente relacionado: PF-8 — actualizar `whatsapp_emergencia` del tenant lh a +584246677030 (número de la guardia) en el panel de Previsión.* |
...
| 6 | Flujo de repatriación / traslado internacional | Casi seguro N/A para FDZ | **CERRADO + DESPLEGADO** (2026-09-09) — servicio confirmado por el cliente; prompt sin hedge. Ligado a PF-8 (número de guardia) |
